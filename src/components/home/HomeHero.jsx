...
export default function HomeHero() {
  return (
    <section className="fb-home-hero relative isolate flex min-h-[100svh] flex-col overflow-hidden bg-[#060618] text-white">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1200px] flex-1 flex-col justify-end px-6 pb-12 pt-[25rem] sm:px-10 sm:pt-[27rem] lg:justify-center lg:px-16 lg:pb-28 lg:pt-36">
        ...
        <p className="fb-home-hero-copy mt-6 max-w-[620px] text-pretty font-poppins text-base leading-relaxed text-white/64 sm:text-lg">
          {HOME_HERO.lede}
        </p>
