...
const Navbar = () => {
  ...
  return (
    ...
    <div className="w-full lg:max-w-[950px] xl:min-w-[1100px]  mx-auto rounded-b-[32px] 3xl:scale-[1.2]">
      <div
        ref={containerRef}
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderImageSource:
              "linear-gradient(90deg, #0606181A 5.74%, #2E2688 22.03%, #01B0EA 26.13%, #FFFFFF 30.23%, #FFFFFF 35.28%, #01B0EA 56.33%, #2E2688 86.42%, #0606181A 90.72%)",
            borderImageSlice: "1",
          }}
        ></div>
