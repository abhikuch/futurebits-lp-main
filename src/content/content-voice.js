...
- Name tools, timelines, and failure modes only when the source material verifies them.
- State a boundary only when it helps a buyer make a decision.
- Avoid repeated contrast formulas such as "not X, but Y" and "we won't."
...
- Do not force lists into groups of three.
- Remove sections that repeat the hero or another section in different words.
...
Use specific tools or timeline ranges only when they are known for that service.`;
