...
function routeMarkdown(path) {
  ...
  if (path === ROUTES.home.path) {
    lines.push(
      ...
      "- A written decision and cut line",
      "- An inspectable artifact in the working stack",
      "- A gate with a reason to continue or stop",
      "- Code, instrumentation, and operating notes that stay with the client",
      "",
      "## Fit",
      "A useful first gate, access to real inputs, and one person able to make scope decisions. Futurebits is not a fit when the deck is the main deliverable or the brief is a 40-feature wishlist.",
      "",
      "## UAE & GCC",
